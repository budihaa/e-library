...
<head>
    ...
    <title>Sistem Perpustakaan Perguruan Tinggi Lepisi Tangerang</title>
...
<body>
    <center>
        <table id="template" align="center">
            <tr>
                <td id="header" style="background:url(images/header.png);width:80%;">
                </td>
            </tr>
            <tr>
                <td>
                    <div style="background:#d7cdea;font-size:16px;font-family:Times New Roman;margin-top:-3px;margin-bottom:-5px">
                        <marquee><b>Selamat Datang Di E-Library Perguruan Tinggi Lepisi Tangerang </b></marquee>
                    </div>
                </td>
            ...
            if ($selisih < 0) {
                ...
                if (isset($_GET['modul'])) {
                    ...
                    if (empty($result)) {
                        ...
                        } else if ((isset($_GET['login'])) && (!isset($_SESSION['userpus']))) {
...
<img src="images/login.jpg" width="150"/>	
	...
	';
            ...
            echo '</div></div><div id="footer">Copyright @2019 Perguruan Tinggi Lepisi Tangerang</div>
</center>
</body>
</html>';
