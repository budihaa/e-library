...
?>
    <tr class="light">
      ...
      <td align="center"><!-- <a href="ebook/<?php echo $data['link']; ?>" target="_BLANK">View</a> -->
      <?php 
	  if($data['kode']==1){
	  ?>
	   <a href="ebook/<?php echo $data['link']; ?>" target="_blank">View</a>
	   <?php } else {
	   ?>
	  <a href="ebook/<?php echo $data['link']; ?>" download="FileName">Download</a>
	 <?php
	 }
	 ?>
      </td>
