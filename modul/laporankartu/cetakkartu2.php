...
$pdf->AddPage();
$pdf->SetFont('Arial','',7);
$sql=mysql_query("select * from anggota where tanggal_daftar between '$_POST[dari]' and '$_POST[sampai]' order by no_agt");
...
$pdf->SetFont('Arial','',7);
$pdf->SetX(60);
$pdf->CELL(15,4,'|  NIRM',0,0,'L',1);
$pdf->SetX(75);
$pdf->cell(20,4,': '.$data['nirm'],0,1,'L',1);
$pdf->SetX(5);
...
$pdf->SetX(5);
$pdf->CELL(30,4,'Prodi/Jur/Lokal',0,0,'L',1);
$pdf->SetX(35);
$pdf->cell(28,4,': '.$data['prodi'].' / '.$data['jurusan'].' / '.$data['kelas'],0,0,'L',1);
$pdf->SetX(132);
...
$pdf->SetX(15);
$pdf->cell(35,4,$pdf->Image('../../images/anggota/'.$data['id_anggota'].'.jpg',$pdf->GetX(),$pdf->GetY()+5,16,19),0,0,'L',0);
$pdf->SetFont('Arial','',7);
$pdf->SetX(40);
...
$tgls = '1';
}elseif ($tanggalsekarang == "02"){
$tgls = '2';
}elseif ($tanggalsekarang == "03"){
$tgls = '3';
}elseif ($tanggalsekarang == "04"){
$tgls = '4';
}elseif ($tanggalsekarang == "05"){
$tgls = '5';
}elseif ($tanggalsekarang == "06"){
$tgls = '6';
}elseif ($tanggalsekarang == "07"){
$tgls = '7';
}elseif ($tanggalsekarang == "08"){
$tgls = '8';
}elseif ($tanggalsekarang == "09"){
$tgls = '9';
}else{
$tgls = $tanggalsekarang;
}
...
$pdf->SetX(40);
$pdf->cell(28,3,"Tembilahan, $tgls $bulan $tahunsekarang",0,0,'L',1);
$pdf->SetX(132);
...
$pdf->cell(28,3,'( '.$tampilkepala['nama_kepala_perpustakaan'].' )',0,1,'L',1);
$pdf->SetX(10);
$i++;
$pdf->Ln(10);
$pdf->SetFont('Arial','',7);
