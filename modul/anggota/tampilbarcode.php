...
font-weight:bold;
	...
	<table id='tabel' style='width:750px; height:230px;'><tr>
		...
		<tr><td height='80px'><img src='../../images/lepisi.jpeg' width='80px' <></td>
	<td colspan='2' width='295px' height='55px' style='vertical-align:center'><span id='headkartu'><center>Kartu Anggota </br>Perpustakaan LEPISI</center></span></td>
...
Jika Kartu Hilang, </br>Segera Hubungi Petugas Perpustakaan</center></td></tr>
	...
	<tr><td height='70px' colspan='2'><img src='../../images/anggota/".$_GET['text'].".jpg' width='130px'/></td><td>
