...
{	
$qry	= mysql_query("SELECT MAX(CONCAT(LPAD((RIGHT((no_peminjaman),6)+1),6,'0')))FROM peminjaman");
$qry2	= mysql_query("SELECT MIN(CONCAT(LPAD((RIGHT((no_peminjaman),6)),6,'0')))FROM peminjaman");	
$kode= mysql_fetch_array($qry);
$kode2= mysql_fetch_array($qry2);
$singkatanggota = substr($_POST['no_anggota'],0,6);
if ($kode2[0]!="000001"){
$kodeauto = "000001";
}
else{
...
<img width='180px' height='90' src='images/lepisi.jpeg'></td>
...
<tr>
	<td>Nim.Mhs</td><td> : $tampil[nim]</td>
</tr>
<tr>
